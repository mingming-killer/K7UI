...
/**
 * Base on android support v4 {@link PagerAdapter}. 
 * This PagerAdapter is match {@link CoolViewPager}. </p>
 * 
 * Base class providing the adapter to populate pages inside of
 * a {@link CoolViewPager}.  You will most likely want to use a more
 ...
 */
public abstract class CoolPagerAdapter {
    ...
    /**
     * Update item. When back data set is changed, you should update the item view.
     * 
     * @param container The containing View which is displaying this adapter's
     * page views.
     * @param position The page position to be update.
     * @param object The same object that was returned by
     * {@link #instantiateItem(View, int)}.
     */
    public abstract void updateItem(ViewGroup container, int position, Object object);
     ...
     * in the adapter.
     *
     * <p>The default implementation is check old position whether in new data set range.
     * If in returns {@link #POSITION_UNCHANGED}, not will return {@link #POSITION_NONE}.
     *
     * @param position Object old position.
     ...
     */
    public int getItemPosition(int position, Object object) {
        //return POSITION_UNCHANGED;
    	
    	// when item position is large than whole adapter range,
    	// we remove it.
