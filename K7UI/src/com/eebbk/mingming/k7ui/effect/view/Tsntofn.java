...
public class Tsntofn extends Trigger {
	
	public Tsntofn(State from, State to) {
		super(from, to);
	}
	...
	public boolean fire(Bullet bullet, Object obj) {
		...
		int totalPage = hostView.getTotalPage();
		if (!hostView.isLoopShow() && currentPage >= (totalPage - 1)) {
			return false;
		}
